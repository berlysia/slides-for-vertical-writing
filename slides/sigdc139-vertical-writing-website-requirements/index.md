...
メインコンテンツとして縦書きを使うなら、<wbr />既存の縦スクロール体験と整合させる必要がある
</div>
...
しかもこのレイアウト構造は、<wbr />縦書き言語だけに留まらない
...
<div style="font-size: 3.5cqh; color: #666;">
なお、縦書きのみで構成するWebと、<wbr />縦横を混用するWebでは設計課題が異なる
</div>
...
<div class="punch">
<div style="font-size: 4cqh; color: #666; margin-block-end: 2cqh;">縦書きのみで構成するWebも<br />縦横を混用するWebも<br />それぞれ独自の設計課題を持つ</div>
<div style="font-size: 3cqh; color: #888; margin-block-end: 2cqh;">とりわけ混用の設計は<br />未踏の問題が多い</div>
<div class="highlight-box">
